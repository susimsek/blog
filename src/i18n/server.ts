...
const dictionaries = {
  en: {
    ...
    'admin-email-change': () =>
      import('@root/public/locales/en/admin-email-change.json').then(module => module.default as NamespaceResource),
    'admin-login': () =>
    ...
    games: () => import('@root/public/locales/en/games.json').then(module => module.default as NamespaceResource),
  ...
  tr: {
    ...
    'admin-email-change': () =>
      import('@root/public/locales/tr/admin-email-change.json').then(module => module.default as NamespaceResource),
    'admin-login': () =>
    ...
    games: () => import('@root/public/locales/tr/games.json').then(module => module.default as NamespaceResource),
