  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Get in touch with Şuayb Şimşek via email, LinkedIn, Medium, or GitHub. Always open to discussing new projects and collaborations."
        />
        <meta name="keywords" content="Şuayb Şimşek, contact, email, LinkedIn, Medium, GitHub" />
