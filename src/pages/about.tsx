  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about Şuayb Şimşek, a passionate backend and fullstack developer from Turkey. Explore his experience, education, and online presence."
        />
        <meta name="keywords" content="Şuayb Şimşek, backend developer, fullstack developer, blockchain, DevOps" />
