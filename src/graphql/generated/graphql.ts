...
export type PostRuntimeQuery = { __typename?: 'Query', post: { __typename?: 'PostResult', status: ContentQueryStatus, engagement?: { __typename?: 'PostEngagement', postId: string, likes: number, hits: number, comments: number } | null }, comments: { __typename?: 'CommentListResult', status: CommentQueryStatus, postId: string, total: number, threads: Array<{ __typename?: 'CommentThread', root: { __typename?: 'Comment', id: string, parentId?: string | null, authorName: string, avatarUrl?: string | null, content: string, createdAt: string }, replies: Array<{ __typename?: 'Comment', id: string, parentId?: string | null, authorName: string, avatarUrl?: string | null, content: string, createdAt: string }> }> } };
